...
export type GetFollowUpAggregateType<T extends FollowUpAggregateArgs> = {
    [P in keyof T & keyof AggregateFollowUp]: P extends '_count' | 'count' ? T[P] extends true ? number : Prisma.GetScalarType<T[P], AggregateFollowUp[P]> : Prisma.GetScalarType<T[P], AggregateFollowUp[P]>;
};
...
export type GetFollowUpGroupByPayload<T extends FollowUpGroupByArgs> = Prisma.PrismaPromise<Array<Prisma.PickEnumerable<FollowUpGroupByOutputType, T['by']> & {
    [P in ((keyof T) & (keyof FollowUpGroupByOutputType))]: P extends '_count' ? T[P] extends boolean ? number : Prisma.GetScalarType<T[P], FollowUpGroupByOutputType[P]> : Prisma.GetScalarType<T[P], FollowUpGroupByOutputType[P]>;
}>>;
export type FollowUpWhereInput = {
    ...
    customerId?: Prisma.IntFilter<"FollowUp"> | number;
    createdById?: Prisma.IntFilter<"FollowUp"> | number;
...
export type FollowUpScalarWhereWithAggregatesInput = {
    ...
    customerId?: Prisma.IntWithAggregatesFilter<"FollowUp"> | number;
    createdById?: Prisma.IntWithAggregatesFilter<"FollowUp"> | number;
};
...
export type FollowUpOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "note" | "createdAt" | "customerId" | "createdById", ExtArgs["result"]["followUp"]>;
...
export type FollowUpCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = Omit<FollowUpFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface FollowUpDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
    [K: symbol]: {
        types: Prisma.TypeMap<ExtArgs>['model']['FollowUp'];
        meta: {
            name: 'FollowUp';
        };
    };
     ...
     * })
    **/
    count<T extends FollowUpCountArgs>(args?: Prisma.Subset<T, FollowUpCountArgs>): Prisma.PrismaPromise<T extends runtime.Types.Utils.Record<'select', any> ? T['select'] extends true ? number : Prisma.GetScalarType<T['select'], FollowUpCountAggregateOutputType> : number>;
    /**
    ...
    **/
     ...
     *
    **/
    groupBy<T extends FollowUpGroupByArgs, HasSelectOrTake extends Prisma.Or<Prisma.Extends<'skip', Prisma.Keys<T>>, Prisma.Extends<'take', Prisma.Keys<T>>>, OrderByArg extends Prisma.True extends HasSelectOrTake ? {
        ...
        [P in OrderFields]: P extends ByFields ? never : `Error: Field "${P}" in "orderBy" needs to be provided in "by"`;
    }[OrderFields]>(args: Prisma.SubsetIntersection<T, FollowUpGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetFollowUpGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>;
    /**
...
export interface FollowUpFieldRefs {
    ...
    readonly createdById: Prisma.FieldRef<"FollowUp", 'Int'>;
}
/**
 * FollowUp findUnique
 */
